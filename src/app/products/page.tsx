  ...
  return (
    <main className="w-full min-h-screen py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header className="border-b border-gray-200 pb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
          ...
          <div className="flex gap-4 px-6 py-3 rounded-xl border border-gray-200 shadow-sm text-sm">
        ...
        <div className="mt-12 space-y-16">
          {productCategories.map((category) => (
            <section key={category.slug} className="p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between border-b border-gray-100 pb-4 mb-6">
                <div>
