...
export default function Nav(){
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50 w-full bg-gray-900 border-b border-slate-700 shadow-md">
          ...
          <MenuItems transition className="absolute right-[-50] z-50 mt-2 w-64 origin-top-right rounded-xl bg-gray-900 p-2 shadow-xl ring-1 ring-white/5 focus:outline-none">
            <motion.div
            initial="initial"
            animate="animate"
            exit="exit"
      ...
      <Menu as="div" className="relative">
        ...
        <div className={`fixed inset-0 w-full min-h-screen min-h-dvh bg-gray-900 text-gray-100 flex flex-col items-start justify-start transition-transform duration-500 ease-in-out z-20 ${
